...
|----------|----------------------|---------------------------|-------------------|------------------------------|----------|
| PAC     | 自动分流代理/直连    | SwitchyOmega、Clash PAC   | 域名/IP 分流     | 本地: 127.0.0.1:21883/pac<br>远程: pac.机场.com | 交通警察 |
| 广告规则 | 杀广告/弹窗/追踪器   | uBlock Origin、AdGuard    | 域名+路径+隐藏   | 订阅链接或插件内规则         | 清洁工   |
